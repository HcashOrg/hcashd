hcashd allows you to bind the RPC server to specific interfaces which enables you
...
|--rpclisten=:18009|all interfaces on port 18009|
|--rpclisten=0.0.0.0:18009|all IPv4 interfaces on port 18009|
|--rpclisten=[::]:18009|all IPv6 interfaces on port 18009|
|--rpclisten=127.0.0.1:18009|only IPv4 localhost on port 18009|
|--rpclisten=[::1]:18009|only IPv6 localhost on port 18009|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:18009|IPv4 localhost on port 8337 and IPv6 localhost on port 14009|
|--rpclisten=:18009 --listen=:8337|all interfaces on ports 18009 and 8337|
