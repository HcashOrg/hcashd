...
reason, the hcashd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire hcashd
...
One of the major design goals of all core hcashd packages is to aim for complete
...
- If a commit modifies a component in any of the packages besides the main  
  package use the package name as the commit prefix (eg. `hcashjson`).
...
contributions.  This is how to get your changes into hcashd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/HcashOrg/hcashd/graphs/contributors)!
...
[ISC license](https://github.com/HcashOrg/hcashd/blob/master/LICENSE).  This is
the same license as all of the code in the hcashd suite.
