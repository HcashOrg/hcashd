...
hypercash transaction scripts.

Script Overview

Hypercash transaction scripts are written in a stack-base, FORTH-like language.

The hypercash script language consists of a number of opcodes which fall into
...
The vast majority of Hypercash scripts at the time of this writing are of several
...
what conditions must be met in order to spend hypercashs.
