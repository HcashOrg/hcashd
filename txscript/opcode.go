...
const (
	...
	OP_NOP9                = 0xb8 // 184
	OP_NOP10               = 0xb9 // 185
	OP_SSTX                = 0xba // 186 HYPERCASH
	OP_SSGEN               = 0xbb // 187 HYPERCASH
	OP_SSRTX               = 0xbc // 188 HYPERCASH
	OP_SSTXCHANGE          = 0xbd // 189 HYPERCASH
	OP_CHECKSIGALT         = 0xbe // 190 HYPERCASH
	OP_CHECKSIGALTVERIFY   = 0xbf // 191 HYPERCASH
