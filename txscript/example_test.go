...
func ExamplePayToAddrScript() {
	...
	// PayToAddrScript.
	addressStr := "HsDLAAP6zDtWop9K1Bs4GTzvm4iCB9EUg81"
	address, err := hcashutil.DecodeAddress(addressStr)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func ExampleSignTxOutput() {
	...
	addr, err := hcashutil.NewAddressPubKeyHash(pubKeyHash,
	...
	// contains a single output that pays to address in the amount of 1 HCASH.
	...
	lookupKey := func(a hcashutil.Address) (chainec.PrivateKey, bool, error) {
