...
const (
	...
	MaxScriptElementSize  = 8192 // Max bytes pushable to the stack.
)
...
func calcSignatureHash(script []parsedOpcode, hashType SigHashType,
	...
	//
	// Hypercash mitigates this by actually returning an error instead.
...
// when entering the UTXO set. In Hypercash, all zero value outputs are unspendable.
