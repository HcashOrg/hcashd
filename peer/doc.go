...
/*
Package peer provides a common base for creating and managing Hypercash network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the hypercash wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe hypercash peer for handling hypercash
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of hypercash protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling hypercash protocol messages
...
caller to specify things such as the user agent name and version, the hypercash
network to use, which services it supports, and callbacks to invoke when hypercash
...
In order to do anything useful with a peer, it is necessary to react to hypercash
...
For convenience, a callback hook for all of the currently supported hypercash
...
(https://godoc.org/github.com/HcashOrg/hcashd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
