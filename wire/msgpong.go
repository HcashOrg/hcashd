...
// MsgPong implements the Message interface and represents a hypercash pong
// message which is used primarily to confirm that a connection is still valid
// in response to a hypercash ping message (MsgPing).
//
...
// NewMsgPong returns a new hypercash pong message that conforms to the Message
