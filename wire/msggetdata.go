...
// MsgGetData implements the Message interface and represents a hypercash
...
// NewMsgGetData returns a new hypercash getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new hypercash getdata message that conforms to
