...
// MsgFilterClear implements the Message interface and represents a hypercash
...
// NewMsgFilterClear returns a new hypercash filterclear message that conforms to the Message
