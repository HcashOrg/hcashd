...
type BlockHeader struct {
	...
	// Hash of the previous key block in the block chain.
	PrevKeyBlock chainhash.Hash
	...
	// KeyHeight is the key block height in the block chain.
	KeyHeight uint32
...
func NewBlockHeader(version int32, prevHash *chainhash.Hash, prevKeyHash *chainhash.Hash,
	...
	poolsize uint32, bits uint32, sbits int64, height uint32, keyHeight uint32, size uint32,
...
// readBlockHeader reads a hypercash block header from r.  See Deserialize for
// decoding block headers stored to disk, such as in a database, as opposed to
// decoding from the wire.
func readBlockHeader(r io.Reader, pver uint32, bh *BlockHeader) error {
	return readElements(r, &bh.Version, &bh.PrevBlock, &bh.PrevKeyBlock, &bh.MerkleRoot,
