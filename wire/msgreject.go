...
// MsgReject implements the Message interface and represents a hypercash reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	plen := uint32(0)
	// Unfortunately the hypercash protocol does not enforce a sane
...
// NewMsgReject returns a new hypercash reject message that conforms to the
