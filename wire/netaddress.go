...
// maxNetAddressPayload returns the max payload size for a hypercash NetAddress
...
type NetAddress struct {
	...
	// not present in the hypercash version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The hypercash protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Hypercash protocol mixes little and big endian.
