...
// MsgFilterAdd implements the Message interface and represents a hypercash
...
// NewMsgFilterAdd returns a new hypercash filteradd message that conforms to the
