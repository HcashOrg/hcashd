...
// subversion would typically be something like "/Hcashd:0.7.2/" (15 bytes)
...
// MsgAlert  implements the Message interface and defines a hypercash alert
// message.
//
...
// NewMsgAlert returns a new hypercash alert message that conforms to the Message
