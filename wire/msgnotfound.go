...
// MsgNotFound defines a hypercash notfound message which is sent in response to
...
// NewMsgNotFound returns a new hypercash notfound message that conforms to the
