...
// MsgMerkleBlock implements the Message interface and represents a hypercash
...
// NewMsgMerkleBlock returns a new hypercash merkleblock message that conforms to
