...
// MsgMemPool implements the Message interface and represents a hypercash mempool
...
// NewMsgMemPool returns a new hypercash pong message that conforms to the Message
