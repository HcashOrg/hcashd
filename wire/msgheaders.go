...
// a single hypercash headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a hypercash headers
...
// NewMsgHeaders returns a new hypercash headers message that conforms to the
