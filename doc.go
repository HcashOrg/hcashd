...
The default options are sane for most users.  This means hcashd will work 'out of
...
parsed when hcashd starts up.  By default, the configuration file is located at
~/.hcashd/hcashd.conf on POSIX-style operating systems and %LOCALAPPDATA%\hcashd\hcashd.conf
...
Application Options:
  ...
  -a, --addpeer=            Add a peer to connect with at startup
      ...
      --listen=             Add an interface/port to listen for connections
                            (default all interfaces port: 11008, testnet: 11008)
