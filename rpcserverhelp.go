...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, HCASHD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawsstx-amount--desc":  "The destination address as the key and the amount in HCASH as the value",
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in HCASH as the value",
	...
	"scriptpubkeyresult-addresses": "The hypercash addresses associated with this script",
	"scriptpubkeyresult-commitamt": "The ticket commitment value if the script is for a staking commitment",

	// Vout help.
	"vout-value":        "The amount in HCASH",
	...
	"decodescriptresult-addresses": "The hypercash addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (hcashd extension)",
	...
	"getcurrentnet--synopsis": "Get hypercash network the server is running on.",
	...
	"infowalletresult-balance":         "The total hypercash balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in HCASH/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in HCASH/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in hypercash",
	...
	"gettxoutresult-value":         "The transaction amount in HCASH",
	...
	"searchrawtransactions-address":     "The Hypercash address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (hcashd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown hcashd.",
	"stop--result0":  "The string 'hcashd stopping.'",
	...
	"validateaddresschainresult-address": "The hypercash address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Hypercash address to validate",
	...
	"verifymessage-address":   "The hypercash address to use for the signature",
	...
	// -------- Hypercash-specific help --------

	// EstimateFee help.
	"estimatefee--synopsis": "Returns the estimated fee in hcash/kb.",
	...
	// TicketFeeInfo help.
	"ticketfeeinfo--synopsis":            "Get various information about ticket fees from the mempool, blocks, and difficulty windows (units: HCASH/kB)",
	...
	"ticketfeeinforesult-feeinfomempool": "Ticket fee information for all tickets in the mempool (units: HCASH/kB)",
	"ticketfeeinforesult-feeinfoblocks":  "Ticket fee information for a given list of blocks descending from the chain tip (units: HCASH/kB)",
	"ticketfeeinforesult-feeinfowindows": "Ticket fee information for a window period where the stake difficulty was the same (units: HCASH/kB)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*hcashjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*hcashjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatestakediff":     {(*hcashjson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]hcashjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*hcashjson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	...
	"getstakedifficulty":    {(*hcashjson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*hcashjson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*hcashjson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*hcashjson.GetHeadersResult)(nil)},
	"getinfo":               {(*hcashjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*hcashjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*hcashjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*hcashjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]hcashjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*hcashjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*hcashjson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*hcashjson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*hcashjson.GetVoteInfoResult)(nil)},
	"getwork":               {(*hcashjson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*hcashjson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*hcashjson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]hcashjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*hcashjson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*hcashjson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*hcashjson.TxFeeInfoResult)(nil)},
	...
	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*hcashjson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := hcashjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := hcashjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
