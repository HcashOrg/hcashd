...
// FileContents is a string containing the commented example config for hcashd.
...
; The default is ~/.hcashd/data on POSIX OSes, $LOCALAPPDATA/Hcashd/data on Windows,
; ~/Library/Application Support/Hcashd/data on Mac OS, and $homed/hcashd/data on
...
; line.  hcashd will not contact 3rd-party sites to obtain external ip addresses.
...
; with, but the behavior is slightly different.  By default, hcashd will query DNS
...
; addpeer=192.168.1.1
; addpeer=10.0.0.2:18008
; addpeer=fe80::1
; addpeer=[fe80::2]:18008
...
; connect=192.168.1.1
; connect=10.0.0.2:18008
; connect=fe80::1
; connect=[fe80::2]:18008
...
; Disable DNS seeding for peers.  By default, when hcashd starts, it will use
...
;   listen=::
; All interfaces on port 18008:
;   listen=:18008
; All ipv4 interfaces on port 18008:
;   listen=0.0.0.0:18008
; All ipv6 interfaces on port 18008:
;   listen=[::]:18008
; Only ipv4 localhost on port 18008:
;   listen=127.0.0.1:18008
; Only ipv6 localhost on port 18008:
;   listen=[::1]:18008
...
; which is used to control and query information from a running hcashd process.
;
...
; All ipv6 interfaces on default port:
;   rpclisten=::
; All interfaces on port 18009:
;   rpclisten=:18009
; All ipv4 interfaces on port 18009:
;   rpclisten=0.0.0.0:18009
; All ipv6 interfaces on port 18009:
;   rpclisten=[::]:18009
; Only ipv4 localhost on port 18009:
;   rpclisten=127.0.0.1:18009
; Only ipv6 localhost on port 18009:
;   rpclisten=[::1]:18009
...
; log level for individual subsystems.  Use hcashd --debuglevel=show to list
