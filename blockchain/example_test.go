...
// overview documentation describes, this includes all of the Hypercash consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := hcashutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main Hypercash block chain.
