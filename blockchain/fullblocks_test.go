...
import (
	...
	"github.com/HcashOrg/hcashd/blockchain/fullblocktests"
...
// DOESN'T WORK YET
func DNWTestFullBlocks(t *testing.T) {
	...
	chain, teardownFunc, err := blockchain.SetupTestChain("fullblocktest",
	...
	testAcceptedBlock := func(item fullblocktests.AcceptedBlock) {
		...
		block := hcashutil.NewBlock(item.Block)
