	...
	tests := []struct {
	...
	}{
		{
			...
			utds: []UndoTicketData{{
				...
				TicketHeight:    122222,
				TicketKeyHeight: 122220,
				Missed:          false,
				Revoked:         true,
				Spent:           true,
				Expired:         false,
			}},
			serialized: hexToBytes("0ce8d4ef4dd7cd8d62dfded9d4edb0a774ae6a41929a74da23109e8f11139c8740e201003fe20100094a6c419a1e25c85327115c4ace586decddfe2990ed8f3d4d801871158338501d6edd01006cdd010006"),
		},
	}
