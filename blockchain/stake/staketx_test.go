...
func TestIsSStx(t *testing.T) {
	var sstx = hcashutil.NewTx(sstxMsgTx)
	...
	sstx = hcashutil.NewTxDeep(sstxMsgTx)
...
func TestIsSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = hcashutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = hcashutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = hcashutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = hcashutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = hcashutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = hcashutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = hcashutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = hcashutil.NewTx(&tx)
	...
	var sstxWrongPrefix = hcashutil.NewTx(&tx)
...
func TestIsSSGen(t *testing.T) {
	...
	ssgen = hcashutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestIsSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = hcashutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = hcashutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = hcashutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = hcashutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = hcashutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = hcashutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = hcashutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = hcashutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = hcashutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = hcashutil.NewTx(&tx)
	...
	var ssgenLongDataPush1Length = hcashutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = hcashutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = hcashutil.NewTx(&tx)
...
func TestIsSSRtx(t *testing.T) {
	var ssrtx = hcashutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = hcashutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = hcashutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = hcashutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = hcashutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = hcashutil.NewTx(&tx)
...
func TestGetSSGenBlockVotedOn(t *testing.T) {
	...
	blockHash, height, _, err := stake.SSGenBlockVotedOn(ssgen.MsgTx())
...
func TestVerifyRealTxs(t *testing.T) {
	...
	sstxTx := hcashutil.NewTx(sstxMtx)
	...
	ssrtxTx := hcashutil.NewTx(ssrtxMtx)
