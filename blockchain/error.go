...
const (
	...
	//ErrVoteBitsNotCompatible indicates that the block does not have the same viewpoint of
	//whether the last key block is valid(on votebits)
	ErrVoteBitsNotCompatible

	//ErrNoSuchBlock indicates that can not find a block hash from index.
	ErrNoSuchBlockHash
...
var errorCodeStrings = map[ErrorCode]string{
	...
	ErrVoteBitsNotCompatible:  "ErrVoteBitsNotCompatible",

	ErrNoSuchBlockHash:		   "ErrNoSuchBlockHash",
