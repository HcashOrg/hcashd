...
The hypercash block handling and chain selection rules are an integral, and quite
likely the most important, part of hypercash.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
ascertained from the bitcoind source code.  At its core, hypercash is a
...
Since this package does not deal with other hypercash specifics such as network
...
Hypercash Chain Processing Overview
