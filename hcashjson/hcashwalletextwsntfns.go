...
const (
	// TicketPurchasedNtfnMethod is the method of the hcashwallet
	// ticketpurchased notification.
	TicketPurchasedNtfnMethod = "ticketpurchased"

	// VoteCreatedNtfnMethod is the method of the hcashwallet
	// votecreated notification.
	VoteCreatedNtfnMethod = "votecreated"

	// RevocationCreatedNtfnMethod is the method of the hcashwallet
