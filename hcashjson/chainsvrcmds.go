...
// transaction hash and output number pair. Contains Hypercash additions.
...
func NewGetBlockSubsidyCmd(height int64, keyHeight int64, voters uint16) *GetBlockSubsidyCmd {
